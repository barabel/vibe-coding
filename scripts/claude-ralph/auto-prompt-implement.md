# Ralph Auto Implement Instructions

Автономный агент. Один issue за вызов, через скилл implement.
...
2. Все → выведи `<promise>COMPLETE</promise>` и заверши ответ, скрипт остановится.
3. Не все → просто заверши ответ, следующий issue сделает следующая итерация.

**ЖЁСТКОЕ ПРАВИЛО: один issue за вызов. После маркера DONE — конец ответа, без исключений.**
